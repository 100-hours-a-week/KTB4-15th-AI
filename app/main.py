...
from app.body_image_validation import router as body_image_validation_router
from app.body_image_validation.runtime import runtime_manager
...
app.include_router(body_image_validation_router.router)
